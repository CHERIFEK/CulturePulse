...
// Initial Mock Data to make the dashboard look good immediately
const INITIAL_DATA: Submission[] = [
  { id: '1', mood: 4, feedback: "Great team spirit this week! The new project launch went smoother than expected.", timestamp: Date.now() - 10000000 },
  { id: '2', mood: 2, feedback: "I'm feeling a bit overwhelmed with the workload. We need better prioritization.", timestamp: Date.now() - 8000000 },
  { id: '3', mood: 5, feedback: "Loved the team lunch! It really helped us bond.", timestamp: Date.now() - 5000000 },
  { id: '4', mood: 3, feedback: "Meetings are dragging on too long. Can we enforce a strict agenda?", timestamp: Date.now() - 2000000 },
  { id: '5', mood: 4, feedback: "The new tools are helpful, but the learning curve is steep.", timestamp: Date.now() - 1000000 },
];
...
const App: React.FC = () => {
  ...
  const handleSubmission = (newSubmission: Submission) => {
    setSubmissions(prev => [...prev, newSubmission]);
    // After submission, automatically switch to dashboard to see result
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 relative">
      ...
      {/* Top Navbar */}
      <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-slate-200 px-4 py-3 flex justify-center items-center">
